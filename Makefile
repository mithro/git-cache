...
CACHE_SOURCES = git-cache.c github_api.c submodule.c cache_recovery.c cache_metadata.c checkout_repair.c strategy_detection.c config_file.c
GITHUB_SOURCES = github_api.c
CACHE_OBJECTS = $(CACHE_SOURCES:.c=.o)
GITHUB_OBJECTS = $(GITHUB_SOURCES:.c=.o)
HEADERS = git-cache.h github_api.h submodule.h cache_recovery.h cache_metadata.h checkout_repair.h strategy_detection.h config_file.h
